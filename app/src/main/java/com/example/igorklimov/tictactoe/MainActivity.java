...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!btGame && !gameController.wifiGame) {
    ...
    public void cellClick(View view) {
        if (gameController.playersTurn && !gameController.done) {
            ...
            if (!gameController.isTaken[row][col]) {
                ...
                gameController.field[row][col] = gameController.playersChar;
                gameController.isTaken[row][col] = true;
                gameController.playersTurn = false;
                gameController.turnCount++;
                gameController.checkVictory();
                if (!btGame && gameController.turnCount != 9 && !gameController.done && !gameController.wifiGame) {
    ...
    void setText(int row, int col) {
        ...
        if (!gameController.done) {
            ...
            gameController.field[row][col] = gameController.opponentChar;
